...
async function runTests() {
  ...
  try {
    ...
    // Previous bug: eq(frozenWallet.id, frozenWallet.id) was always true, returning wrong row
    ...
    if (db && testCustomerId!) {
      // Clean up frozen wallet transactions
      ...
      // Clean up main wallet transactions
