...
const sendMessageInput = z.object({
  ...
  context: z.object({
    ...
    selectedPayrollId: z.string().optional(),
    payrollBatches: z.array(z.any()).optional(),
    leaveRecords: z.array(z.any()).optional(),
  }).optional(),
});

const updateUserConfigInput = z.object({
  preferences: z.object({}).optional(),
  hotkeys: z.object({}).optional(),
...
const uploadFileInput = z.object({
  ...
  mimeType: z.string(),
  analysisType: z.enum(["invoice", "contract", "document", "receipt", "general"]),
});
