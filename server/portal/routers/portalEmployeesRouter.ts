  ...
  submitOnboarding: portalHrProcedure
    .input(
      z.object({
        ...
        probationPeriodDays: z.number().min(0).default(0),
    ...
    .query(async ({ input }) => {
      ...
      const [invite] = await db
        .select({
          ...
          probationPeriodDays: onboardingInvites.probationPeriodDays,
      ...
      return {
        ...
        probationPeriodDays: invite.probationPeriodDays,
    ...
    .mutation(async ({ input }) => {
      ...
      if (serviceType === "aor") {
        ...
        const result = await createEmployee({
          ...
          startDate: startDate as any,
          endDate: invite.endDate || null,
          probationPeriodDays: invite.probationPeriodDays ?? 0,
